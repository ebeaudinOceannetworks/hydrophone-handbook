...
Hydrophone data files are generated in 5-minute intervals, categorized as either **raw sensor recordings** (direct acoustic pressure measurements) or **derived products** (downstream spectral transformations).
...
| **Derived** | Hydrophone Spectral Data | `HSD` (45) | `.fft`, `.mat`, `.png`, `.pdf`, `.oct` |
| **Derived** | Spectral Probability Density | `HSPD` (51) | `.mat`, `.png`, `.pdf` |

: Quick lookup matrix for ONC hydrophone file types. {tbl-colwidths="[15,40,15,30]"}
