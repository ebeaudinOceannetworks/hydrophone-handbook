---
title: "13. Science and Publications"
---
...
In 2015, ONC joined the Enhancing Cetacean and Habitat Observation ([ECHO](https://www.portvancouver.com/environment/healthy-ecosystem/echo)) Program aims at investigating ways to reduce shipping traffic impacts on whale activity in the Strait of Georgia.
As part of the program, hydrophone arrays from *JASCO Applied Sciences* were deployed and the data ingested in ONC’s servers.

The program has had quite a bit of success, as thousands of ships have voluntarily reduced speed or distanced themselves from whales.
...
Whale monitoring is ongoing, thanks to in-house bioacoustician Lynn Rannankari, who helps identify species as well as differentiate different calls that a single species makes and relates to their behaviour, and their seasonal presence.
...
# Publications
A non-exhaustive list of scientific papers from ONC hydrophone data.
