...
# Which method to use?
There are 3 ways to get the data: from ONC data portal [Oceans3.0](https://data.oceannetworks.ca), or using the ONC API.
...
Navigate to the [Map](8-hydrophone-network.qmd) page to find past and current deployments.
...
Certain hydrophone (mostly Ocean Sonics) have *anscillary data*, such as acceleration, internal humidity, temperature, etc.
...
For each data product, several format are available, such as pdf, .mat, .txt, etc.  

![](../images/Data-Search-step-5-6-7.png){lightbox=true}

### 6. Select the product options
Most order of data product can also be customized through the *Data Product Options* panel below.
...
This simply add the product to the cart, which you can find in View Cart in the top right.
