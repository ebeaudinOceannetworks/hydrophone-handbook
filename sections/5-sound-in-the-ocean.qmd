...
---
*For deeper dive into the physics of sound, see [DOSITS: Science of Sound](https://dosits.org/science/sound/what-is-sound/).*
...
| **Refraction** | The ray bends toward slower sound speed as $T$, $S$, or pressure change ([Snell's law](16-useful-equations.qmd#snells-law)). | SOFAR and surface ducts; shadow zones. |
...
Ray tracing is used at ONC to locate sources, estimate detection range, plan new sites, and avoid “deaf zones.” The underlying [wave equation](16-useful-equations.qmd#wave-equation) is in Useful Equations.
