...
![Typical seasonal sound speed profile in the Northeast Pacific, including waters off British Columbia.](../images/ssp_seasonal_modified.png){lightbox=true}
...
From a source (a whale) to a receiver (a hydrophone), the sound level (SL) can drop significantly. That drop is due to **transmission loss (TL)**, or propagation loss. The received sound level (RL) becomes:
...
Ray tracing is used at ONC to locate sources, estimate detection range, plan new sites, and avoid “deaf zones.” The underlying [wave equation](15-acoustic-equations.qmd#wave-equation) is in Acoustic Equations.
