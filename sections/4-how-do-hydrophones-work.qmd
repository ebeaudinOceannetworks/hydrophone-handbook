...
![Fourier analysis for signal decomposition. Credit: Medium.](../images/fourier-transform.png)
...
![Example of a spectrogram: time on the x-axis, frequency in Hz on the y-axis, and colour for sound level.](../images/spectrogram.png)
...
![Signal-to-noise ratio measures the desired signal against background noise. Credit: Hollyland.](../images/snr.png)
