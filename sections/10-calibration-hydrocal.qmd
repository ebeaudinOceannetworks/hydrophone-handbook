---
title: "10. Calibration (HydroCal)"
---

::: {.callout-note}
## In progress

This chapter is under construction. Topics: HydroCal, sensitivity curves, and tank-test, validation.
:::

<!-- handbook-draft: to publish this text, delete the opening HTML comment on this line and the matching closer at the end of the file.
...
![Hydrophone calibration performed at the MTC, using in-house calibration system HydroCal.](../images/MTC_hydrocal.png){lightbox=true}
...
![Hydrophone sensitivity curve from calibration.](../images/hydrophone-calibration.png){lightbox=true}
