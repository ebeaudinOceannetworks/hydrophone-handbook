...
The hydrophone configuration is dictated primarily by the scientific objectives of ocean monitoring.
At Ocean Networks Canada, passive acoustic infrastructure falls into two deployment configurations:

* **Single Hydrophone Nodes:** Simpler and least expensive method for long-term soudscape monitoring
...
At 1 metre between the elements, it is possible to localize sounds emitted roughly between 100-750 Hz, for example Humback Whales.
...
## Interference
When adding hydrophones to a multi-instrument platform, all nearby infrastructure should ideally be evaluated for noise, although this is a arduous task and we generally know after the fact if there is interference and to what intensity.
...
* **Trilateration (Position & Range):** Uses measurements across multiple widely-separated hydrophones to calculate the the spatial coordinates ($lat,lon$) of a sound.
